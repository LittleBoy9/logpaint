/**
 * logpaint Feature Demo for NestJS
 * ─────────────────────────────────────────────────────────────────
 ...
 * 8. Full TypeScript support with generics
 *
 * Run with: npx ts-node src/demo.ts
 */

import { log, colorShowcase, filteredLog, simpleLog } from './logger';

console.log(
  '\n╔════════════════════════════════════════════════════════════════╗',
);
console.log(
  '║         logpaint - Full Feature Demo (NestJS/TypeScript)       ║',
);
console.log(
  '╚════════════════════════════════════════════════════════════════╝\n',
);
...
console.log('Full IntelliSense support for custom levels!');
console.log('Type `log.` and see: debug, info, success, warn, error, http, db');
log.info('TypeScript knows all methods: log.http, log.db are typed!');
